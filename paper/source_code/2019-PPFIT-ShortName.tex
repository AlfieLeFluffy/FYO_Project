\documentclass[11pt]{PPFIT} % pro psaní v angličtině / for writing in English
%\documentclass[english]{PPFIT} % pro psaní v češtině / for writing in Czech
...
\hypersetup{
	pdftitle={Hubble telescope, Webb telescope - optical system description},
	pdfauthor={Bc. Tomáš Vlach},
	pdfkeywords={Hubble telescope, James Web telescope, Web telescope, optical system, optics, visualization}
}
...
\ifczechslovak%
  ...
  \PaperTitle{Hubble and Webb Telescope - Optical System Overview}
    ...
    %--------------------------------------------------------
    \Abstract{
        A brief overview of the optical systems of the Hubble and James Web telescope. This paper goes over the main ideas and principles of these systems.
...
\else%
	...
	\Authors{Bc. Tomáš Vlach}
	\affiliation{*%
		\href{mailto:xvlach24@stud.fit.vutbr.cz}{xvlach24@stud.fit.vutbr.cz},
		\textit{Faculty of Information Technology, Brno University of Technology}}

	\Keywords{Hubble telescope, James Web telescope, Web telescope, optical system, optics, visualization, telescope detectors}
	
	\Supplementary{\href{https://github.com/AlfieLeFluffy/FYO_Project}{Github Repository} --- \href{https://nextcloud.fit.vutbr.cz/s/6m7eiHwGNefcPF4}{Nextcloud Mirror}}
    ...
    %--------------------------------------------------------
    \Abstract{
    A brief overview of the optical systems of the Hubble and James Web space telescopes. This paper goes over the main ideas and principles of these systems, the instruments onboard, detectors used and other relevant mechanisms.
    }
\fi
